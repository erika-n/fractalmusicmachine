    ...
    public partial class Form1 : Form
    {
       // static int TRANSITION_TIME = 3;
        ...
        private void fractalMakerBackgroundWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            WavFile.Save("fractal.wav", _buildingFractal.getSound());
...
/////
       ...
       private void loadVariablesFromForm()
       {
           ...
           int seconds, depth, minWaves, maxWaves, cutoffHigh, cutoffLow;
           double amplitude, baseFreq;
           if (!System.Int32.TryParse(secondsTextBox.Text, out seconds) || seconds < 1 || seconds > 600)
           {
           ...
           _fractalVariables.oscillator = oscillatorComboBox.SelectedIndex;
           if (sampleComboBox.SelectedItem != null)
           {
               _fractalVariables.sample = sampleComboBox.SelectedItem.ToString();
           }
